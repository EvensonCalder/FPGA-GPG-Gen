...
module tb_ed25519_ht_fe17_batch_affine4;
    logic clk = 1'b0;
    logic rst_n = 1'b0;
    always #2 clk = ~clk;
    ...
    logic start;
    logic done;
    logic [255:0] seed_in [0:3];
    fe17_t x [0:3], y [0:3], z [0:3];
    fe17_t t_unused [0:3];
    logic [255:0] expected_public [0:3];
    logic [255:0] seed_out [0:3];
    logic [255:0] public_key [0:3];

    ed25519_ht_fe17_batch_affine4 dut (
    ...
    task automatic load_vectors;
        ...
        begin
            if (!$value$plusargs("VECTOR_FILE=%s", vector_file))
                vector_file = "sim/ht_batch_affine4_vectors.mem";
    ...
    initial begin
        ...
        begin
            ...
            $display("PASS tb_ed25519_ht_fe17_batch_affine4 cycles=%0d", cycles);
        end
        $finish;
    end
endmodule
