...
module tb_ed25519_ht_fe17_square_pipe;
    ...
    ed25519_ht_fe17_square_pipe dut (
        .clk(clk),
        .rst_n(rst_n),
        .in_valid(in_valid),
        .a(a),
    ...
    task automatic load_vectors;
        ...
        begin
            if (!$value$plusargs("VECTOR_FILE=%s", vector_file))
                vector_file = "sim/ht_fe17_square_vectors.mem";
    ...
    initial begin
        ...
        $display("PASS tb_ed25519_ht_fe17_square_pipe vectors=%0d", recv_idx);
        $finish;
    end
endmodule
