...
module ed25519_ht_keygen_batch16_pingpong_stage (
    input  logic         clk,
    input  logic         rst_n,
    ...
    logic [255:0] seed_buf [0:1][0:15];
    fe17_t x_buf [0:1][0:15];
    fe17_t y_buf [0:1][0:15];
    fe17_t z_buf [0:1][0:15];
    logic [255:0] batch_seed [0:15];
    logic [255:0] batch_public [0:15];
    logic batch_start;
    logic batch_done;
    ...
    ed25519_ht_fe17_batch_affine16 u_batch (
