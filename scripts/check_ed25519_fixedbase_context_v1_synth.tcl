...
set proj_dir [file normalize "build/vivado_ed25519_fixedbase_context_v1_synth_${suffix}"]
file mkdir $proj_dir
create_project ed25519_fixedbase_context_v1_synth $proj_dir -part xc7k160tffg676-2 -force
...
set_property top ed25519_fixedbase_context_v1 [current_fileset]
synth_design -top ed25519_fixedbase_context_v1 -part xc7k160tffg676-2
