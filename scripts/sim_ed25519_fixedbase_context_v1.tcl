set proj_dir [file normalize "build/vivado_ed25519_fixedbase_context_v1_sim"]
set ref_dir [file normalize "saif_ed25519_ref"]
file mkdir $proj_dir
create_project ed25519_fixedbase_context_v1_sim $proj_dir -part xc7k160tffg676-2 -force
...
foreach f [list \
    ...
    [file normalize "rtl/ed25519_ge_p1p1_to_p2p3_v1.sv"] \
    [file normalize "rtl/ed25519_fixedbase_context_v1.sv"] \
...
add_files -fileset sim_1 [file normalize "sim/tb_ed25519_fixedbase_context_v1.sv"]
set_property file_type SystemVerilog [get_files [file normalize "sim/tb_ed25519_fixedbase_context_v1.sv"]]
set_property top tb_ed25519_fixedbase_context_v1 [get_filesets sim_1]
