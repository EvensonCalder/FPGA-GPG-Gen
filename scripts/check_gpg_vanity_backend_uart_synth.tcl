set proj_dir [file normalize "build/vivado_gpg_vanity_backend_uart_synth"]
file mkdir $proj_dir

create_project gpg_vanity_backend_uart_synth $proj_dir -part xc7k160tffg676-2 -force
foreach f {
    rtl/uart_tx.v
...
set_property top gpg_vanity_backend_uart [current_fileset]
synth_design -top gpg_vanity_backend_uart -part xc7k160tffg676-2 -mode out_of_context
