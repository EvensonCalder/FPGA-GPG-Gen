...
set proj_dir [file normalize "build/vivado_ed25519_fixedbase_context_v2_x2_synth_${suffix}"]
file mkdir $proj_dir
create_project ed25519_fixedbase_context_v2_x2_synth $proj_dir -part xc7k160tffg676-2 -force
...
foreach f [list \
    ...
    [file normalize "rtl/ed25519_fixedbase_context_v2_x2.sv"] \
...
set_property top ed25519_fixedbase_context_v2_x2 [current_fileset]
synth_design -top ed25519_fixedbase_context_v2_x2 -part xc7k160tffg676-2
