...
set proj_dir [file normalize "build/vivado_gpg_vanity_ht_search_top_sim"]
set ref_dir [file normalize "saif_ed25519_ref"]

file mkdir $proj_dir
create_project gpg_vanity_ht_search_top_sim $proj_dir -part xc7k160tffg676-2 -force
...
add_files -fileset sim_1 [file normalize "sim/tb_gpg_vanity_ht_search_top.sv"]
set_property file_type SystemVerilog [get_files [file normalize "sim/tb_gpg_vanity_ht_search_top.sv"]]
set_property top tb_gpg_vanity_ht_search_top [get_filesets sim_1]
