set proj_dir [file normalize "build/vivado_gpg_vanity_search_x2"]
set ref_dir [file normalize "saif_ed25519_ref"]
file mkdir $proj_dir

create_project gpg_vanity_search_x2 $proj_dir -part xc7k160tffg676-2 -force
...
foreach f [list \
    ...
    [file normalize "rtl/ed25519_keygen_x2_pipeline.sv"] \
    [file normalize "rtl/gpg_vanity_search_x2_top.sv"] \
] {
    add_files $f
...
set_property top gpg_vanity_search_x2_top [current_fileset]
add_files -fileset constrs_1 [file normalize "constraints/gpg_vanity_search_x2_top.xdc"]

synth_design -top gpg_vanity_search_x2_top -part xc7k160tffg676-2
...
write_bitstream -force "$proj_dir/gpg_vanity_search_x2_top.bit"
