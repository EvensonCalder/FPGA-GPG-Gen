...
set proj_dir [file normalize "build/vivado_ed25519_fixedbase_context_v2_shared_synth_${suffix}"]
file mkdir $proj_dir
create_project ed25519_fixedbase_context_v2_shared_synth $proj_dir -part xc7k160tffg676-2 -force
...
set_property top ed25519_fixedbase_context_v2_shared [current_fileset]
synth_design -top ed25519_fixedbase_context_v2_shared -part xc7k160tffg676-2
