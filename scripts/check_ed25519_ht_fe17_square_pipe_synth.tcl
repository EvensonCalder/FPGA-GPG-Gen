...
set proj_dir [file normalize "build/vivado_ed25519_ht_fe17_square_pipe_synth"]
set clk_period [expr {[info exists ::env(CLK_PERIOD)] ? $::env(CLK_PERIOD) : 4.500}]

file mkdir $proj_dir
create_project ed25519_ht_fe17_square_pipe_synth $proj_dir -part xc7k160tffg676-2 -force
...
set_property top ed25519_ht_fe17_square_pipe [current_fileset]
synth_design -top ed25519_ht_fe17_square_pipe -part xc7k160tffg676-2
